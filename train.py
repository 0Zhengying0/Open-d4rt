...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--model-config",
        default="configs/repro/worldtrack_sota_ninemix_clip48_a_query_local_lr4e-6_eval64clip/model_effective.yaml",
    )
    parser.add_argument(
        "--train-config",
        default="configs/repro/worldtrack_sota_ninemix_clip48_a_query_local_lr4e-6_eval64clip/train_effective.yaml",
    )
